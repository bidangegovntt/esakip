    ...
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="{{ set_active(['input', 'input/*']) }} treeview">
            ...
            <ul class="treeview-menu">
                ...
                <li class="{{ set_active(['input/perjanjianKinerja2', 'input/perjanjianKinerja2/*']) }}"><a href="{{ url('input/perjanjianKinerja2') }}"><i class="fa fa-circle-o"></i> Perjanjian Kinerja </a></li>
