        ...
        <div class="modal-content">
            <form class="form-horizontal form-create">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="pagu-anggaran" class="col-sm-3 control-label">Pagu Anggaran</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="input-pagu-anggaran" placeholder="Pagu Anggaran">
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        $('.form-create').on('submit', function(e) {
            ...
            var pagu_anggaran = $('#input-pagu-anggaran').val();
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if(response.success) {
                        ...
                        target_kinerja = $('#input-target').val("");
                        pagu_anggaran = $('#input-pagu-anggaran').val("");
                    }
                    var tahun = $('#tahun').val();
                    var tahun_awal = $('#tahun_awal').val();
                    var opd = $('#opd').children("option:selected").val();
