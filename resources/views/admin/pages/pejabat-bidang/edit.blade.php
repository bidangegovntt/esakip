...
<section class="content-header">
    <h1>
        Edit Data Pejabat Bidang
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Pejabat Bidang</a></li>
        ...
        <div class="col-xs-12"> 
            ...
            <div class="box">
                <form
                    ...
                    action="{{ route('pejabat-bidang.update', ['id' => $pejabatBidang->id]) }}"
                    method="POST">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value="{{ old('nip') ? old('nip') : $pejabatBidang->nip }}"
                                name="nip"
                                placeholder="NIP"
                                autofocus />
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value="{{ old('nama') ? old('nama') : $pejabatBidang->nama  }}"
                                name="nama"
                                placeholder="Nama"
                                autofocus />
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control {{ $errors->first('opd_id') ? "is-invalid" : "" }}" name="opd_id" id="opd_id">
                                ...
                                @foreach ($opds as $opd)
                                    <option {{ $opd->id == $pejabatBidang->opd_id ? 'selected' : '' }} value="{{ $opd->id }}">{{ $opd->nama }}</option>
                                @endforeach
                            </select>
                            <div class="invalid-feedback">
                                {{ $errors->first('opd_id') }}
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control {{ $errors->first('bidang_id') ? "is-invalid" : "" }}" name="bidang_id" id="bidang_id">
                                ...
                                @foreach ($bidangs as $bidang)
                                    <option {{ $bidang->id == $pejabatBidang->bidang_id ? 'selected' : '' }} value="{{ $bidang->id }}">{{ $bidang->nama }}</option>
                                @endforeach
                            </select>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control {{ $errors->first('jabatan_id') ? "is-invalid" : "" }}" name="jabatan_id" id="jabatan_id">
                                ...
                                @foreach ($jabatans as $jabatan)
                                    <option {{ $jabatan->id == $pejabatBidang->jabatan_id ? 'selected' : '' }} value="{{ $jabatan->id }}">{{ $jabatan->nama }}</option>
                                @endforeach
                            </select>
                            <div class="invalid-feedback">
