...
<div class="col-md-8">
    ...
    <form enctype="multipart/form-data" class="bg-white shadow-sm p-3" action="{{ route('rencana-strategi.store') }}"
        method="POST">
        @csrf
        ...
        <input type="text" class="form-control {{ $errors->first('tahun') ? "is-invalid" : "" }}"
            value="{{ old('tahun') }}" name="tahun" placeholder="Tahun" />
        <div class="invalid-feedback">
            {{$errors->first('tahun')}}
        </div>
        <br>
        ...
        <textarea name="tujuan" id="tujuan" class="form-control {{$errors->first('tujuan') ? "is-invalid" : ""}} "
        ...
        <textarea name="sasaran" id="sasaran" class="form-control {{$errors->first('sasaran') ? "is-invalid" : ""}} "
        ...
        <textarea name="indikator_kinerja" id="indikator_kinerja"
        ...
        <textarea name="awal" id="awal" class="form-control {{$errors->first('awal') ? "is-invalid" : ""}} "
        ...
        <textarea name="perubahan" id="perubahan"
