        ...
        <div class="modal-content">
            <form class="form-horizontal form-create">
                <div class="modal-header bg-info">
                    <h5 class="modal-title" id="exampleModalLabel">Tambah Data Sasaran</h5>
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form class="form-horizontal form-edit">
                <div class="modal-header bg-info">
                    <h5 class="modal-title" id="exampleModalLabel">Ubah Data Sasaran</h5>
                </div>
                <div class="modal-body">
...
<script>
    $(document).ready(function() {
        ...
        $('.form-edit').on('submit', function(e) {
            ...
            $.ajax({
                url: '{{ URL::route('sasaran.update', 'id') }}',
                type: 'PUT',
                data: {
                    _token: CSRF_TOKEN,
                    id: id,
