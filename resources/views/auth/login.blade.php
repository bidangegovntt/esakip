...
<head>
    <title>Login E-Sakip Purbalingga1</title>
    ...
    * {
    ...
    :root {
        ...
        --loginSubmitBackgroundColor: #FF5733;
...
<body>
    ...
    <body class="align">
        <div class="grid">
            <center><img src="{{ asset('template/images/logo-dark2.png') }}" height="150" width="150" alt="">
            ...
            <form method="POST" action="{{ route('login') }}" class="form login">
                ...
                <div class="form__field">
                    ...
                    <input id="password" type="password" class="form-control @error('password') is-invalid @enderror"
                        name="password" class="form__input" required autocomplete="current-password"
