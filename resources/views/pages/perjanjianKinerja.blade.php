...
<div class="container">
    ...
    <form action="{{ url('/c/sakip/perjanjian-kinerja2/cari') }}" method="POST">
        @csrf
        <div class="row">
            <div class="col-sm-4">
    ...
    <div class="row">
        <div class="col-sm-12">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody id="tabeldata">
                    @foreach ($perjanjianKinerja2s as $key => $perjanjianKinerja2)
                    <tr>
                        <td style="text-align: center;">{{ $key + 1 }}</td>
                        <td>{{ $perjanjianKinerja2->tahun }}</td>
                        <td>{{ $perjanjianKinerja2->data_opd->nama }}</td>
                        <td style="text-align: center;"><a href="{{ asset('file/' . $perjanjianKinerja2->file) }}" class="btn btn-success"><i class="fa fa-download"></i> Unduh</a></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
